...
def performance() -> dict:
    return {
        ...
        "response_messages": {"min": 2000, "median": 2000, "max": 2000},
        "push_messages": {"min": 4000, "median": 4500, "max": 5000},
        "message_count_consistent": True,
        ...
        "active_clients": {"min": 0, "median": 0, "max": 0},
        ...
        "steady_state_target_seconds": {"min": 30, "median": 30, "max": 30},
        "steady_state_elapsed_seconds": {"min": 30, "median": 30, "max": 30},
        "steady_state_completed": True,
        "termination_reasons": ["steady_duration_elapsed"],
    ...
    def test_mode_level_routed_delta_keeps_requests_between_runs(self) -> None:
        ...
        for _ in range(3):
            runs.append({
                ...
                "latency_p99_ms": 3,
                "total_messages": 6000,
                "response_messages": 2000,
                "push_messages": 4000,
                "target_clients": 100,
                "started_clients": 100,
                "tcp_connected_clients": 100,
                "authenticated_clients": 100,
                "active_clients": 0,
                "peak_active_clients": 100,
                "cancelled_clients": 0,
                ...
                "ramp_completed": True,
                "measurement_started": True,
                "steady_state_target_seconds": 30,
                "steady_state_elapsed_seconds": 30,
                "steady_state_completed": True,
