...
using MessagePayload = std::variant<std::monostate,
                                    ...
                                    v2::player::ReconnectTimerExpiredMsg,
                                    v2::player::TokenRefreshMsg,
                                    ...
                                    v2::room::LeaveRoomMsg,
                                    v2::room::KickMemberMsg,
                                    v2::room::TransferOwnerMsg,
                                    ...
                                    v2::battle::PlayerReconnectedMsg,
                                    v2::battle::DisconnectGraceTimerExpiredMsg,
