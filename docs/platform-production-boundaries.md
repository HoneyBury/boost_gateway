...
|---|---|---|---|
| `linux-x64` | ELF x86_64 | 原生进程或 `linux/amd64` Compose | v3.6.5 release target；v3.6.2 已发布复验 |
...
v3.6.5 按 [Linux x64-only patch ADR](decisions/v3.6.3-linux-x64-release.md) 只发布
