...
合并后的预冻结能力 run `29902706777` 已在
`3af898e4d3a09002ea8f7a3742a214e11a7a6d98` 通过默认 smoke、原生 R5、package、
SBOM、checksum 与 dSYM 候选；它不替代最终冻结 SHA 的三次 baseline 与长稳/容量
证据。
...
run `29902706777` 为 14 个 Mach-O 生成 pair，独立校验 `160/160`，两个 archive
及各自 SPDX checksum 均通过；artifact
`macos-arm64-3af898e4d3a09002ea8f7a3742a214e11a7a6d98` 仍是候选而非已发布资产。
