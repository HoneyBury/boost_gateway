...
## Ubuntu fixed-runner / Conan reproducibility

推荐把 Ubuntu fixed-runner 作为 N1/N2/N3 与 release/capacity 的优先事实源，并配合仓库内 Conan profile / lockfile 进行复现：
