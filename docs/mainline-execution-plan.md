# v3.6.3 Linux x64 发布后企业运营主线

更新时间：2026-08-01

## 目标

当前两个月不扩大业务或默认协议面，而是把 v3.6.3 Linux x64 不可变资产交付为可重复运营的
...
1. **冻结部署输入**：只接受 v3.6.3 Linux x64 release archive、checksum、SBOM、provenance 和明确
   的配置版本，不在服务器上构建源码。
