...
from scripts.lib.workflow_catalog_contract import *  # noqa: E402,F401,F403
...
def main() -> int:
    ...
    context = evaluate_catalog_foundation(ROOT, WORKFLOWS_ROOT, catalog_path)
    checks = context.checks
    catalog = context.catalog
    production_platforms = context.production_platforms
    release_platforms = context.release_platforms
